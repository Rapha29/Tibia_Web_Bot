...
const ts3 = new TeamSpeak({
  ...
  serverport: 9989,             // Porta do servidor TS3
...
const adminGroupID = 497;
const editor = 433;
const respconfiga = 501
const respconfigb = 482
const respconfigc = 478
const serveradminGroupID = 3;
const mpoke =  483;
const mmove = 484;
const botadm = 482;
const respblockGroupID = 499;
const convidado = 496;
const SemRegistro = 435;
...
async function updateRespawnChannel() {
  try {
    ...
    let description = "[size=+3]RESPAWN LIST[/size]\n[i]${formattedDate}[/i]\n[url=https://yubra.jowbot.com.br][size=+2][b]CLIQUE AQUI PARA ACOMPANHAR PELO NAVEGADOR OU CELULAR[/b][/size][/url]\n\n";
