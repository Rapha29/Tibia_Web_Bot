...
async function updateRespawnChannel() {
  try {
    ...
    let description = "[size=+3]RESPAWN LIST[/size]\n[i]${formattedDate}[/i]\n[url=https://issobra.newcorporation.com.br/][size=+2][b]CLIQUE AQUI PARA ACOMPANHAR PELO NAVEGADOR OU CELULAR[/b][/size][/url]\n\n";
...
async function showHelp(client) {
  try {
      ...
      if (isAdminUser) {
          ...
          [b]!addresp Venore E84 Amazon Camp[/b]
          [i]Adiciona um novo respawn a lista.[/i]

          [b]!removeresp Venore E84[/b]
          [i]Remove um respawn da lista.[/i]
...
const CHANNEL_ID = 18; // ID do canal onde a lista será exibida
...
async function generateRespawnDescription() {
  try {
    ...
    let description = "[COLOR=#008000][size=+3]Respawn Number List[/size][/COLOR]\n[url=https://issobra.newcorporation.com.br/resplist.html][size=+2][b]CLIQUE AQUI PARA VER TODOS[/b][/size][/url]\n\n";
